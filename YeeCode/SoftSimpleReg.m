...
% The following line adds the inclusion
% Removing it allows the wave to pass through unimpeded.
epi{1}(125:150,100:130)= c_eps_0*11.3;
epi{1}(125:150,60:90)= c_eps_0*11.3;
epi{1}(125:150,20:50)= c_eps_0*11.3;
...
% BC structure sets the boundary conditions
% type = 'ss' indicates a soft source
bc{1}.NumS = 1;
bc{1}.s(1).xpos = nx{1}/(4) + 1;
bc{1}.s(1).type = 'ss';
bc{1}.s(1).fct = @PlaneWaveBC;

% Added in source within a inclusion region
bc{1}.NumS = 2;
bc{1}.s(1).xpos = 135;
bc{1}.s(1).type = 'ss';
bc{1}.s(1).fct = @PlaneWaveBC;
